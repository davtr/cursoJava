		...
		<div align="center">
			<h2><c:out value="Bienvenido a nuestra tienda ${sessionScope.nombrecompl}"/><br><br>
					...
					<div align="center"><h3>
	 				...
	 				<a href="pago.jsp"><input type="submit" name="boton" value="Finalizar Compra"></a><br/>
					<a href="lisarti"><input type="submit" name="boton" value="Volver"></a><br/>
